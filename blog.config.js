...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '星星闪闪发光，是为了让每一个人，有一天可以找到属于自己的星星。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ergua.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 笔记', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '桂ICP备2021001631号', // 备案号 闽ICP备XXXXXX
